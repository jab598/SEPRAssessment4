...
public class PlayerController : MonoBehaviour {
	...
	/// <summary>
	/// Sets super speed cheat New assessment4
	/// </summary>
	/// <param name="val">If set to <c>true</c> is super speed.</param>
	public void setSuperSpeed(bool val) {
		if (val) {
			movementSpeedMod = 2;
		} else {
			movementSpeedMod = 1;
		}
		Debug.Log ("Set movementspeed mod to " + movementSpeedMod);
	}
